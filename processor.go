...
func GetOperations() []Operation {
	return []Operation{
		...
		},
		{
			...
			Description: "Remove code comments (#, //, /* */; arg1=type filter)",
			Func:        removeComments,
			Args:        []ArgSpec{},
		},
		...
		// Phase 16: Data Format Deserialization
		{
			...
			Description: "Deserialize PHP serialized data to JSON (arg1=outputValidJSON true/false)",
			Func:        phpDeserialize,
			Args:        []ArgSpec{},
		},
		...
		{
			Name:        "JSON Format",
			Description: "Format JSON with indentation and optional prefix (arg1=spaces, arg2=prefix)",
			Func:        jsonFormat,
			Args:        []ArgSpec{},
		},
	}
